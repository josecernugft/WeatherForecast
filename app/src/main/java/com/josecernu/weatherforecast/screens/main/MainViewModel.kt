...
class MainViewModel @Inject constructor(private val repository: WeatherRepository): ViewModel() {
    ...
    suspend fun getWeatherData(lat: String, lon: String, units: String): DataOrException<Weather, Boolean, Exception> {
        return repository.getWeather(lat, lon, units = units)
    }
}